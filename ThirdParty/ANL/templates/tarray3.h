...
namespace anl
{
    ...
    public:
        ...
        inline size_t size() const {return width_*height_*depth_;}
        ...
        inline const T& operator () (size_t i, size_t j, size_t k) const {return data_[checkedIndex(i,j,k)];}
        inline T& operator () (size_t i) {return data_[checkedIndex(i)];}
        inline T& operator () (size_t i, size_t j, size_t k) {return data_[checkedIndex(i,j,k)];}

        inline const T* c_data() const {return data_;}
        inline T* c_data() {return data_;}
