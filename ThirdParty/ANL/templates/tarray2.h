...
namespace anl
{
    ...
    public:
        ...
        inline size_t size() const {return width_*height_;}
        ...
        inline const T& operator () (size_t i, size_t j) const {return data_[checkedIndex(i,j)];}
        inline T& operator () (size_t i) {return data_[checkedIndex(i)];}
        inline T& operator () (size_t i, size_t j) {return data_[checkedIndex(i,j)];}
