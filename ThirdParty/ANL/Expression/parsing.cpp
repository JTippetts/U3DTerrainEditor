...
Token::Token(const Token &rhs){type_=rhs.type_; token_=rhs.token_;}
Token::~Token(){}

const Token::ETokenTypes Token::GetType() const {return type_;}
const std::string &Token::GetToken() const {return token_;}
