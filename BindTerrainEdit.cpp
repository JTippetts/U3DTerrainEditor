...
/* method: GetHeightValueFromNormalized of class  TerrainEdit */
#ifndef TOLUA_DISABLE_tolua_BindTerrainEdit_TerrainEdit_GetHeightValueFromNormalized00
static int tolua_BindTerrainEdit_TerrainEdit_GetHeightValueFromNormalized00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetHeightValueFromNormalized'", NULL);
#endif
 {
  float tolua_ret = (float)  self->GetHeightValueFromNormalized(nrm);
 tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
 }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetHeightValueFromNormalized'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: SetMaskBuffer of class  TerrainEdit */
#ifndef TOLUA_DISABLE_tolua_BindTerrainEdit_TerrainEdit_SetMaskBuffer00
static int tolua_BindTerrainEdit_TerrainEdit_SetMaskBuffer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  TerrainEdit* self = (TerrainEdit*)  tolua_tousertype(tolua_S,1,0);
  CArray2Dd* buffer = ((CArray2Dd*)  tolua_tousertype(tolua_S,2,0));
  int which = ((int)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in function 'SetMaskBuffer'", NULL);
#endif
 {
  self->SetMaskBuffer(*buffer,which);
 }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'SetMaskBuffer'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: GetCavityMap of class  TerrainEdit */
#ifndef TOLUA_DISABLE_tolua_BindTerrainEdit_TerrainEdit_GetCavityMap00
static int tolua_BindTerrainEdit_TerrainEdit_GetCavityMap00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  TerrainEdit* self = (TerrainEdit*)  tolua_tousertype(tolua_S,1,0);
  CArray2Dd* buffer = ((CArray2Dd*)  tolua_tousertype(tolua_S,2,0));
  float sampleradius = ((float)  tolua_tonumber(tolua_S,3,0));
  float scale = ((float)  tolua_tonumber(tolua_S,4,0));
  float bias = ((float)  tolua_tonumber(tolua_S,5,0));
  float intensity = ((float)  tolua_tonumber(tolua_S,6,0));
  unsigned int iterations = ((unsigned int)  tolua_tonumber(tolua_S,7,0));
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetCavityMap'", NULL);
#endif
 {
  self->GetCavityMap(*buffer,sampleradius,scale,bias,intensity,iterations);
 }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetCavityMap'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
