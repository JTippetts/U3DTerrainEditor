...
void TerrainContext::Save(const ea::string &path)
{
...
void TerrainContext::Load(const ea::string &path)
{
...
bool TerrainContext::LoadImage(const ea::string &filename, Image &img)
{
