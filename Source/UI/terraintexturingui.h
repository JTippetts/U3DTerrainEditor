...
class TerrainTexturingUI : public Object
{
	...
	std::vector<ea::string> diffuseLayerNames_;
	std::vector<ea::string> normalLayerNames_;
	...
	ea::string selectedDiffImageName_, selectedNormalImageName_;
	...
	SharedPtr<FileSelector> CreateFileSelector(const ea::string &title, const ea::string &oktext, const ea::string &canceltext, const ea::string &initialPath, const ea::vector<ea::string> &filters, unsigned int initialFilter);
	ea::string GetFilenameFromPath(const ea::string &path);
};
